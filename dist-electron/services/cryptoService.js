...
export const cryptoService = {
     ...
     */
    async decryptLegacy(fileBuffer, outputPath, password) {
        try {
    ...
    async saveLocalBackupBinary(data, outputPath) {
        return fs.promises.writeFile(outputPath, data);
    },
    async loadLocalBackupBinary(inputPath) {
        return fs.promises.readFile(inputPath);
    },
    // Aliases & Detection
    async isEncryptedFile(inputPath) {
        try {
    ...
    encryptFile(input, output, pass) {
        return this.encryptBackup(input, output, pass);
    },
    decryptFile(input, output, pass) {
