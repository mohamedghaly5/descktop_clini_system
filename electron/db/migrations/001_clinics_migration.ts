...
export const up = (db: Database.Database) => {
    ...
    `);
        ...
        const existingSettings = db.prepare('SELECT * FROM clinic_settings LIMIT 1').get() as any;
      ...
      `);
            ...
            insert.run(
                'clinic_001',
                existingSettings.clinic_name,
                existingSettings.owner_name,
                existingSettings.phone,
                existingSettings.address,
                existingSettings.email,
                existingSettings.whatsapp_number,
                existingSettings.currency || 'EGP',
                existingSettings.direction || 'rtl',
