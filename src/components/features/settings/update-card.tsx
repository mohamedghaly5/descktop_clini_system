...
import { RefreshCw, Download, AlertCircle, CheckCircle, ArrowUpCircle } from 'lucide-react';
...
export function UpdateCard({ language }: UpdateCardProps) {
    ...
    return (
        <Card className="animate-fade-in bg-card text-card-foreground border" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            <CardHeader>
            ...
            <CardContent>
                <div className="space-y-4">
                    ...
                    <div className="flex justify-end gap-2">
                        {(status === 'idle' || status === 'latest' || status === 'error' || status === 'checking') && (
